...
.proc init_sprites
  ...
  set_sprite oam, 0, 10, 1, (SPRITE_PALETTE_2), 10
  set_sprite oam, 1, 18, 2, (SPRITE_PALETTE_2), 2
  set_sprite oam, 2, 18, 3, (SPRITE_PALETTE_2), 10
  set_sprite oam, 3, 26, 4, (SPRITE_PALETTE_2), 2
  set_sprite oam, 4, 26, 5, (SPRITE_PALETTE_2), 10
  set_sprite oam, 5, 34, 6, (SPRITE_PALETTE_2), 2
